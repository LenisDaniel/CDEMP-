...
// extends from class.users.inc.php
...
class Technicians extends Users
{
    ...
    function get_all_users($role = 2, $tpl_uri = 'manage_technicians')
    {
        global $objmydbcon;
    ...
    function manage_user_info($tpl_uri = "manage_technicians", $id = 0, $first_name = "", $last_name = "", $second_surname = "", $password = "", $email = "", $address1 = "", $address2 = "", $phone_1 = "", $phone_2 = "", $cities_dd = "", $states_dd = "", $zipcode = "", $active = 0, $role_idx = 2){
        global $objmydbcon;
