<?php
    ...
    class classStudents
    {
        ...
        function get_all_clients($role){
            ...
            $i = 0;
            $sqlquery = "SELECT u.idx, u.first_name, u.email, u.phone_1, mr.role_descr, u.active FROM master_users u
                         INNER JOIN master_roles mr ON mr.role_idx = u.role_idx
                         WHERE u.role_idx = $role";
        ...
        function get_cities($student_city = 0){
            global $objmydbcon;
        ...
        function get_state($student_state = 0){
            global $objmydbcon;
