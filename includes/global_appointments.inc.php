...
$objtemplate->set_content('appointments_td', $objappointments->get_all_appointments('global_appointments', $role_idx, $creator));
...
if(isset($_GET['cid'])) {
    ...
    $objappointments->manage_appoint_info('global_appointments', $id, $appoint_descr, $appoint_time, $appoint_place, $appoint_details, $list, $unique_number, $creator);
