...
$objteachers = new Teachers();
    ...
    $objtemplate->set_content("teachers_td", $objteachers->get_all_teachers());

    if(isset($_GET['edit'])){

        $idx = base64_decode($_GET['edit']);
        $objteachers->get_teacher($idx);
        ...
        $objtemplate->set_content("first_name", $objteachers->get_teacher_info('first_name'));
        $objtemplate->set_content("last_name", $objteachers->get_teacher_info('last_name'));
        $objtemplate->set_content("second_surname", $objteachers->get_teacher_info('second_surname'));
        $objtemplate->set_content("email", $objteachers->get_teacher_info('email'));
        $objtemplate->set_content("password", $objteachers->get_teacher_info('password'));
        $objtemplate->set_content("address1", $objteachers->get_teacher_info('address1'));
        $objtemplate->set_content("address2", $objteachers->get_teacher_info('address2'));
        $objtemplate->set_content("cities_dd", $objteachers->get_cities($objteachers->get_teacher_info('city')));
        $objtemplate->set_content("states_dd", $objteachers->get_state($objteachers->get_teacher_info('state')));
        $objtemplate->set_content("phone_1", $objteachers->get_teacher_info('phone_1'));
        $objtemplate->set_content("phone_2", $objteachers->get_teacher_info('phone_2'));
        $objtemplate->set_content("zipcode", $objteachers->get_teacher_info('zipcode'));

        if($objteachers->get_teacher_info('active') == 1){
