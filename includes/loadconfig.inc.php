...
switch ($lang){
    ...
    case "sp" :
         ...
         define("SELECT_OPTION","Seleccione una Opci�n");
         define("ALL_OPTIONS","Todos");
         define("VALUES_NOT_FOUND","Valores no encontrados");
         define("YES","S�");
         define("ADDRESS_TYPE_PHYSICAL","F�sica");
         define("ADDRESS_TYPE_POSTAL","Postal");
         define("EMPTY_RECORD_SET","No records encontrados");
         define("NO","No");
         define("NOTSYNCRONIZED","** No ha Sincronizado");
         define("TITLE_VERSION","Versi�n");
         define("SYNCHRONIZATION_SUCCEED","Sincronizaci�n fue exitosa.");
   		 define("SYNCHRO_FAIL","Sincronizaci� fall�.");
   		 define("SYNCHRO_FILE_NOT_FOUND","Archivo de sincronizaci�n no fue encontrado");
		 define("STORE","Tienda");
		 define("NET_SALES","Ventas Neta");
		 define("GROSS_SALES","Ventas Bruta");
		 define("LAST_POLLED","Ultima Interrogaci�n");
		 define("FROM","Desde");
		 define("TO","Hasta");
...
if ($lang == "sp"){
    ...
    $change_lang = "<a href='change_lang.php?lang=sp$qs'>Versi�n en espa�ol</a>";
} // if $lang ==
