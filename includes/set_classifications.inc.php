...
$objtemplate->set_content("classifications_td", $objconfig->get_all_config('set_classifications', 'classification'));

if(isset($_GET['edit'])){

    $idx = base64_decode($_GET['edit']);
    $objconfig->get_config($idx, "classification");
    ...
    $objtemplate->set_content("classification", $objconfig->get_config_info('classification_descr'));
...
if(isset($_GET['cid'])) {
    ...
    $objconfig->manage_config_info('set_classifications', "classification", $id, $classification, $active);
